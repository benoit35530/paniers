...
echo html_colonne("5%","","left","","","","",html_bouton_submit("Ajouter une date"));
echo html_fin_form();
echo html_debut_form("?action=filtrer",false,"formfiltrer");
if(!isset($idperiode)) {
    $idperiode = "-2";
}
echo html_colonne("","","center","","","","",afficher_liste_periodes("idperiode",$idperiode,false,true) . html_bouton_submit("Lister les dates par période"));
echo html_fin_form();
echo html_fin_ligne();
