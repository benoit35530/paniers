...
if(!utilisateurIsAdmin() && obtenir_producteur_utilisateur() == -1) {
...
echo html_colonne("","","left","","","","",html_bouton_submit("Ajouter un produit"));
echo html_fin_form();
echo html_debut_form("?",false,"formlister");
echo html_colonne("","","right","","","","",html_bouton_submit("Lister les produits"));
echo html_fin_form();
echo html_fin_ligne();
