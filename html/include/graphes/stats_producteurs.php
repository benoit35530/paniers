...
$ochart->setTitle(sprintf("Commandes par p�riode (moyenne : %2.2f, total : %2.2f, min : %2.2f, max : %2.2f)",$moyenne,$nb_total_commandes,$min,$max),$coltext,3);
...
$ochart->setXAxis($coltext,SOLID,2,"P�riode");
